...
fixes the logbook's **checklist** page and lists this other one in its TODO
(*"Champion Upgrade Page in logbook is wonky"*). Both mods are compatible and deal with
different screens.
